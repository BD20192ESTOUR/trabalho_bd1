CREATE VIEW PONTOS_POPLARES_VILAVELHA AS Select nome_pontoturistico, descricao, publico_alvo, tipo_ambiente from pontoturistico left outer join evento on (pontoturistico.idpontoturistico = evento.idpontoturistico)
...
SELECT *FROM PONTOS_POPLARES_VILAVELHA;